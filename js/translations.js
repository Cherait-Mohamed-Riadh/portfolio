...
(function() {
    ...
    const translations = {
        en: {
            ...
            'expertise.kpi.years': 'Years',
            'expertise.kpi.assessments': 'Assessments',
            'expertise.kpi.enterprise': 'Enterprise',
            'expertise.kpi.algorithms': 'Algorithms',
            'expertise.kpi.markets': 'Markets',
            'expertise.kpi.projects': 'Projects',
            'expertise.kpi.algorithms': 'Algorithms',
            'expertise.kpi.markets': 'Markets',
            'expertise.kpi.projects': 'Projects',
            'expertise.badge.featured': 'Featured',
            'expertise.badge.demand': 'In-Demand',
            'expertise.badge.speed': '7 Days',
            'expertise.cta.security': 'View detailed services',
            'expertise.cta.analysis': 'View market insights',
            'expertise.cta.web': 'View web packages',
        ...
        ar: {
            ...
            'expertise.badge.featured': 'مميز',
            'expertise.badge.demand': 'الأكثر طلباً',
            'expertise.badge.speed': '7 أيام',
            'expertise.cta.security': 'عرض الخدمات بالتفصيل',
            'expertise.cta.analysis': 'عرض رؤى السوق',
            'expertise.cta.web': 'عرض باقات الويب',
            'expertise.kpi.years': 'سنوات',
            'expertise.kpi.assessments': 'تقييمات',
            'expertise.kpi.enterprise': 'مؤسسات',
        ...
        fr: {
            ...
            'expertise.badge.featured': 'Mis en avant',
            'expertise.badge.demand': 'Très demandé',
            'expertise.badge.speed': '7 jours',
            'expertise.cta.security': 'Voir les services détaillés',
            'expertise.cta.analysis': 'Voir les analyses du marché',
            'expertise.cta.web': 'Voir les offres web',
            'expertise.kpi.years': 'Années',
            'expertise.kpi.assessments': 'Audits',
            'expertise.kpi.enterprise': 'Entreprises',
